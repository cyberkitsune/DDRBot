...
def generate_embed(score_data, score_player):
    ...
    emb.add_field(name="<:eming:572201816792629267> Miss", value="%s" % score_data.score_miss_count, inline=True)
    emb.add_field(name="📅 Played On", value="%s" % score_data.date_stamp, inline=True)
...
def generate_embed_from_db(score_data, score_player):
    ...
    emb.add_field(name="👀 Marvelous", value="%s" % score_data.marv_count, inline=True)
    emb.add_field(name="👌 Perfect", value="%s" % score_data.perf_count, inline=True)
    ...
    emb.add_field(name="<:eming:572201816792629267> Miss", value="%s" % score_data.miss_count, inline=True)
