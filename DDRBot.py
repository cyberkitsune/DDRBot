...
def generate_embed(score_data, score_player):
    ...
    OK_percent = (int(score_data.score_OK_count.value) / total_notes) * 100
    ...
    emb.add_field(name="<:emiok:572201794982248452> OK", value="%s (%0.2f%%)" % (score_data.score_OK_count, OK_percent), inline=True)
...
def generate_embed_from_db(score_data, score_player, verified=False, cmd_prefix='k!'):
    ...
    OK_percent = (int(score_data.OK_count) / total_notes) * 100
